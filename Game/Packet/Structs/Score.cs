namespace Emulator {
	...
	public struct Score {
		...
		public static Score operator + ( Score Current , Score Other ) {
			...
			Current.Resist[0] += Other.Resist[0];
			Current.Resist[1] += Other.Resist[1];
			Current.Resist[2] += Other.Resist[2];
			Current.Resist[3] += Other.Resist[3];
		...
		public static Score operator + ( Score Current , SItemList Item ) {
			for ( int i = 0 ; i < Item.Ef.Length ; i++ ) {
				...
				switch ( Item.Ef [ i ].Index ) {
					...
					case 49:
						Current.Resist[0] += val;
						break;

					case 50:
						Current.Resist[1] += val;
						break;

					case 51:
						Current.Resist[2] += val;
						break;

					case 52:
						Current.Resist[3] += val;
						break;
		...
		public static Score operator * ( Score Current , double Multiplier ) {
			...
			Current.Resist[0] *= Multiplier;
			Current.Resist[1] *= Multiplier;
			Current.Resist[2] *= Multiplier;
			Current.Resist[3] *= Multiplier;
